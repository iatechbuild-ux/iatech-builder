-- User metadata is controlled by the signing-up user. It must never grant a
-- privileged application role. Tutor/admin roles are assigned later by an
-- authenticated administrator through the protected admin workflow.
